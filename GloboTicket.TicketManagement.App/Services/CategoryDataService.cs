...
public class CategoryDataService(IClient client, IMapper mapper, ILocalStorageService localStorage) : BaseDataService(client, localStorage), ICategoryDataService
{
